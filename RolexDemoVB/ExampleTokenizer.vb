...
Namespace RolexDemoVB
    <System.CodeDom.Compiler.GeneratedCodeAttribute("Rolex", "1.0.0.0")>  _
    ...
    Friend Structure DfaTransitionEntry
        ...
        Public Sub New(ByVal packedRanges() As Integer, ByVal destination As Integer)
    ...
    Friend Class TableTokenizer
        ...
        End Function
        Public Sub New(ByVal dfaTable() As DfaEntry, ByVal blockEnds()() As Integer, ByVal nodeFlags() As Integer, ByVal input As IEnumerable(Of Char))
            MyBase.New
    ...
    Friend Class TableTokenizerEnumerator
        ...
        Private _inputCurrent As Integer
        ...
        Public Sub New(ByVal dfaTable() As DfaEntry, ByVal blockEnds()() As Integer, ByVal nodeFlags() As Integer, ByVal input As IEnumerator(Of Char))
            MyBase.New
            Me._dfaTable = dfaTable
            Me._blockEnds = blockEnds
            Me._nodeFlags = nodeFlags
        ...
        Function System_Collections_IEnumerator_MoveNext() As Boolean Implements System.Collections.IEnumerator.MoveNext
            ...
            Do While (false = done)
                ...
                If (TableTokenizerEnumerator.ErrorSymbol < Me._current.SymbolId) Then
                    Dim be() As Integer = Me._blockEnds(Me._current.SymbolId)
        ...
        Function _MoveNextInput() As Boolean
            If Me._input.MoveNext Then
                Me._inputCurrent = System.Convert.ToInt32(Me._input.Current)
                If Char.IsHighSurrogate(Me._input.Current) Then
                    If (false = Me._input.MoveNext) Then
                        Throw New IOException("Unexpected end of input while looking for Unicode low surrogate.")
                    End If
                    Me._position = (Me._position + 1)
                    Me._inputCurrent = Char.ConvertToUtf32(System.Convert.ToChar(Me._inputCurrent), Me._input.Current)
                End If
                If (false  _
                            = (TableTokenizerEnumerator._BeforeBegin = Me._state)) Then
                    Me._position = (Me._position + 1)
                    If (10 = Me._inputCurrent) Then
                        Me._column = 1
                        Me._line = (Me._line + 1)
                    Else
                        If (9 = Me._inputCurrent) Then
                ...
                Else
                    ...
                    Else
                        If (9 = Me._inputCurrent) Then
                            Me._column = (TableTokenizerEnumerator._TabWidth - 1)
                        Else
                            Me._column = (Me._column - 1)
                        End If
                    End If
            ...
            Return false
        End Function
        Function _TryReadUntil(ByVal character As Integer) As Boolean
            Dim ch As Integer = Me._inputCurrent
            Me._buffer.Append(Char.ConvertFromUtf32(ch))
            ...
            Do While (Me._MoveNextInput  _
                        AndAlso (false  _
                        = (Me._inputCurrent = character)))
                Me._buffer.Append(Char.ConvertFromUtf32(Me._inputCurrent))

            Loop
            If (false  _
                        = (Me._state = TableTokenizerEnumerator._InnerFinished)) Then
                Me._buffer.Append(Char.ConvertFromUtf32(Me._inputCurrent))
                Return (System.Convert.ToInt32(Me._input.Current) = character)
            End If
            Return false
        End Function
        Function _TryReadUntilBlockEnd(ByVal blockEnd() As Integer) As Boolean
            ...
            Do While ((false  _
                ...
                Do While (found  _
                    ...
                    If ((false = Me._MoveNextInput)  _
                                OrElse (false  _
                                = (Me._inputCurrent = blockEnd(i)))) Then
                        found = false
                    Else
                        If (false  _
            ...
            Do While (false = done)
                ...
                Do While (i < Me._dfaTable(dfaState).Transitions.Length)
                    ...
                    Do While (j < entry.PackedRanges.Length)
                        Dim ch As Integer = Me._inputCurrent
                        Dim first As Integer = entry.PackedRanges(j)
                        j = (j + 1)
                        Dim last As Integer = entry.PackedRanges(j)
                        If (ch <= last) Then
                            If (first <= ch) Then
                                found = true
                            End If
